...
const Footer = ({ className }: { className?: String }) => {
  return (
    <footer
      className={`className flex h-14 w-full items-center border-t pl-6 pr-6 font-medium ${className}`}
    >
      <div className="xs:mb-0 flex w-full justify-center">
        <div className="flex flex-row items-center justify-between gap-6 border-t border-white/5">
          <p className="text-xs text-gray-600">Linear - Built by Vinit Raut</p>
          <div className="flex gap-3">
            <Link className="group" to="/twitter">
            ...
            <Link className="group" to="/github">
